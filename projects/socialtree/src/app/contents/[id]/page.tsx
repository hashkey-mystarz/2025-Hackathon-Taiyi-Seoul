					...
					<div className="border-t border-gray-200 pt-6">
									...
									>
										...
										<div className="flex">
											<input
												type="text"
												readOnly
												value={generateReferralLink() || '지갑 연결 필요'}
												className="flex-1 p-2 text-xs bg-gray-50 border border-gray-300 rounded-l-lg focus:outline-none"
											/>
											<button
												onClick={copyReferralLink}
												disabled={!isConnected}
												className="p-2 bg-primary text-white rounded-r-lg disabled:bg-gray-300"
											>
						...
						<button
							...
							className={`w-full py-3 rounded-lg flex justify-center items-center font-medium ${
								subscribed ? 'bg-green-100 text-green-700 cursor-default' : 'bg-primary text-white hover:bg-primary/90'
							}`}
						>
